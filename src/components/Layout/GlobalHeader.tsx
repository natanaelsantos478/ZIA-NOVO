...
export default function GlobalHeader() {
  ...
  return (
    <header className={`h-16 bg-${config.primaryColor}-600 text-white flex items-center justify-between px-6 shadow-md z-50 relative`}>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="relative">
          ...
          {/* Menu Dropdown */}
          {profileOpen && (
            <div className="absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-2xl border border-slate-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right">
              ...
              <div className="p-1">
                ...
                <button className="w-full flex items-center px-3 py-2 text-sm text-slate-600 hover:bg-slate-50 hover:text-indigo-600 rounded-lg transition-colors">
                  <Settings className="w-4 h-4 mr-3" /> Configurações da Loja
                </button>
              </div>
