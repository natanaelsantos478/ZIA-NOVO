...
export default function ModuleHub() {
  ...
  const modules = [
    { id: 'crm', name: 'Vendas (CRM)', icon: Briefcase, desc: 'Gestão comercial e inteligência de leads', color: 'from-purple-500 to-indigo-600', active: true },
    ...
    { id: 'eam', name: 'Ativos (EAM)', icon: Wrench, desc: 'Manutenção, inventário e IoT', color: 'from-blue-500 to-cyan-600', active: config.features.enableEAM },
    { id: 'scm', name: 'Logística (SCM)', icon: Truck, desc: 'Frota, fretes e supply chain', color: 'from-emerald-500 to-teal-600', active: true },
    { id: 'erp', name: 'Backoffice (ERP)', icon: Building, desc: 'Financeiro, fiscal e contábil', color: 'from-slate-700 to-slate-900', active: config.features.enableERP },
  ];
