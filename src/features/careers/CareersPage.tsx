...
import {
  ...
  Filter, ChevronRight, Building2, Sparkles,
} from 'lucide-react';
...
export default function CareersPage() {
  const { getPublicVacancies } = useVacancies();
  const vacancies = getPublicVacancies();
  ...
  const filtered = vacancies.filter((v) => {
    ...
    const matchModality = !filterModality || v.modality === filterModality;
    const matchType = !filterType || v.type === filterType;
    const matchDept = !filterDept || v.dept === filterDept;
    return matchSearch && matchModality && matchType && matchDept;
  });
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <div className="flex items-center gap-1 text-pink-600 text-sm font-semibold group-hover:gap-2 transition-all">
