    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          valores: { type: 'array', description: 'Valores para escrever', items: { type: 'array', items: { type: 'string' } } },
        },
        required: ['operacao'],
      },
    },
    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          slides: { type: 'array', description: 'Array de slides com titulo e conteudo cada', items: { type: 'object', properties: { titulo: { type: 'string' }, conteudo: { type: 'string' } } } },
        },
        required: ['operacao'],
      },
    },
